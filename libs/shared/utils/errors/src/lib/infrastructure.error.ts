...
export const DatabaseError = (message = 'Database error', cause?: Error, options?: ErrorOptions) => {
...
export const ExternalServiceError = (message = 'External service error', cause?: Error, options?: ErrorOptions) => {
  return InfrastructureError.fromJSON({
    statusCode: 502,
    errorCode: options?.errorCode,
