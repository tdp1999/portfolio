 ...
 */
export function createMockHttpResponse<T>(data: T, status = 200, statusText = 'OK'): MockHttpResponse<T> {
...
export const httpErrors = {
  ...
  serverError: () => createMockHttpError(500, 'Internal Server Error', 'An unexpected error occurred'),
