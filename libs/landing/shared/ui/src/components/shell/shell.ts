  ...
  constructor() {
    ...
    const disposers = [
      this.shortcuts.register({
        id: 'theme-toggle',
        description: 'shortcut.theme.toggle',
        keys: ['mod+shift+l'],
        category: 'shortcut.category.appearance',
        iconName: 'sun',
        handler: () => this.theme.toggle(),
      }),
      this.shortcuts.register({
        id: 'go-home',
        description: 'shortcut.goHome',
        keys: ['mod+shift+h'],
      ...
      this.shortcuts.register({
        id: 'go-projects',
        description: 'shortcut.goProjects',
        keys: ['mod+shift+p'],
        category: 'shortcut.category.navigation',
