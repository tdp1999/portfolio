...
import { LandingIconArrowComponent } from './landing-icon-arrow.component';

describe('LandingIconArrowComponent', () => {
  let fixture: ComponentFixture<LandingIconArrowComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(LandingIconArrowComponent);
  });
