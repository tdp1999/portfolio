...
@Component({
  selector: 'console-principle-form-page',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    RouterLink,
  ...
  templateUrl: './principle-form-page.html',
  styleUrl: './principle-form-page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class PrincipleFormPageComponent implements OnInit, HasUnsavedChanges {
