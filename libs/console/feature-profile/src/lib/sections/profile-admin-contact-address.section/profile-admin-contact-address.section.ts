...
import { FormSnapshotDirective, SectionCard, SectionStatus, ToastService } from '@portfolio/console/shared/ui';
...
@Component({
  ...
  templateUrl: './profile-admin-contact-address.section.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProfileAdminContactAddressSection {
