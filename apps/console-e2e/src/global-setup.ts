...
async function globalSetup(): Promise<void> {
  ...
  // Clean up skills created by test users (FK constraint: skills_createdById_fkey)
  ...
  // Clean up categories created by test users (FK constraint: categories_createdById_fkey)
  ...
  // Clean up tags created by test users (FK constraint: tags_createdById_fkey)
  ...
  // Clean up media created by test users (FK constraint: media_createdById_fkey)
