...
export class ProfilePresenter {
  static toPublicResponse(
    ...
    return {
      ...
      bioLongJson: profile.bioLongJson,
      bioLongHtml: profile.bioLongHtml,
      bioLongSchemaVersion: profile.bioLongSchemaVersion,
      bioLongCanonical: profile.bioLongCanonical,
