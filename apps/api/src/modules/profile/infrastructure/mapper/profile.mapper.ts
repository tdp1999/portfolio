...
export class ProfileMapper {
  static toDomain(raw: PrismaProfile): Profile {
    const props: IProfileProps = {
      ...
      aboutHeading: parseTranslatableNullable(raw.aboutHeading),
  ...
  static toPrisma(profile: Profile): Prisma.ProfileUncheckedCreateInput {
    return {
      ...
      aboutHeading: (profile.aboutHeading as unknown as Prisma.InputJsonValue) ?? Prisma.DbNull,
      aboutLede: (profile.aboutLede as unknown as Prisma.InputJsonValue) ?? Prisma.DbNull,
      ctaHeading: (profile.ctaHeading as unknown as Prisma.InputJsonValue) ?? Prisma.DbNull,
      ctaLede: (profile.ctaLede as unknown as Prisma.InputJsonValue) ?? Prisma.DbNull,
