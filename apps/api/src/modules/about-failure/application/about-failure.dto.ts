...
const YearSchema = () =>
  z
    ...
    .min(LIMITS.FAILURE_YEAR_MIN, `year must be ≥ ${LIMITS.FAILURE_YEAR_MIN}`)
...
export const CreateAboutFailureSchema = z.object({
  ...
  year: YearSchema(),
  context: TranslatableTextSchema(LIMITS.FAILURE_CONTEXT_MAX, 'context'),
  decision: TranslatableTextSchema(LIMITS.FAILURE_NARRATIVE_MAX, 'decision'),
  consequence: TranslatableTextSchema(LIMITS.FAILURE_NARRATIVE_MAX, 'consequence'),
  lesson: TranslatableTextSchema(LIMITS.FAILURE_NARRATIVE_MAX, 'lesson'),
...
export const UpdateAboutFailureSchema = z
  .object({
    ...
    context: TranslatableTextSchema(LIMITS.FAILURE_CONTEXT_MAX, 'context').optional(),
    decision: TranslatableTextSchema(LIMITS.FAILURE_NARRATIVE_MAX, 'decision').optional(),
    consequence: TranslatableTextSchema(LIMITS.FAILURE_NARRATIVE_MAX, 'consequence').optional(),
    lesson: TranslatableTextSchema(LIMITS.FAILURE_NARRATIVE_MAX, 'lesson').optional(),
