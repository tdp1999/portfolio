...
import type { Paragraph } from './ddl-story-variants.types';
import {
  DROP_CAP_LETTER,
  FIRST_PARAGRAPH_TAIL,
  JOURNAL_CHIPS,
  JOURNAL_META,
  LAMP_EXTRA_PARAGRAPHS,
  PARAGRAPHS,
  TIMELINE_EVENTS,
} from './ddl-story-variants.data';

@Component({
  selector: 'landing-ddl-story-variants',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [Container, Eyebrow, Breadcrumb],
  templateUrl: './ddl-story-variants.html',
  styleUrl: './ddl-story-variants.scss',
})
export class DdlStoryVariants {
  // ──────── Data ────────────────────────────────────────────────────────
