...
import type { SortKey, ViewMode } from './ddl-blog-list.types';
import {
  QUERY,
  VIEW_OPTIONS,
  SORT_OPTIONS,
...
@Component({
  ...
  templateUrl: './ddl-blog-list.html',
  styleUrl: './ddl-blog-list.scss',
})
export class DdlBlogList {
  // ── Decision record ────────────────────────────────────────────────
  protected readonly variants: readonly DdlVariant[] = BLOG_LIST_VARIANTS;
