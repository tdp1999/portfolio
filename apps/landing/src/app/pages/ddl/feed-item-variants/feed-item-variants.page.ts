...
@Component({
  selector: 'landing-feed-item-variants-page',
  standalone: true,
  ...
  templateUrl: './feed-item-variants.page.html',
  styleUrl: './feed-item-variants.page.scss',
})
export class FeedItemVariantsPage {
