...
import { DEMO, HERO_VARIANTS } from './ddl-hero.data';

@Component({
  selector: 'landing-ddl-hero',
  standalone: true,
  ...
  template: `
    <landing-ddl-doc-page slug="hero" [width]="'wide'">
      <p class="hv-lead font-sans text-body-md text-landing-text-400 max-w-2xl">
        Five entrance compositions over one hero — same name, role, lead, and hire meta. α (settled stagger) shipped to
        <code>landing-home-hero</code> via <code>landing-stagger-text</code>; the spotlight now lives site-wide on
        <code>landing-shell</code> (theme-aware, follows the cursor everywhere). The rest stay as the considered record.
      </p>

      <landing-ddl-decision-record [variants]="variants" />

      <!-- ═══ Shipped — α settled stagger (the winner, full mock) ═══════════ -->
      <landing-ddl-section anchor="alpha" heading="Shipped — α stagger">
        <landing-ddl-stage width="full" label="α — settled stagger">
      ...
      <!-- ═══ Considered — V1 / V2 · β marquee · γ mask wipe ═══════════════ -->
      <landing-ddl-considered label="Considered — V1 / V2 · β marquee · γ mask wipe">
        <!-- V1 — Anchor (kept as safe fallback) -->
        <div class="hv-considered-variant">
          <h4 class="hv-vh">V1 — anchor (fallback)</h4>
          <landing-ddl-stage width="full" label="V1 — anchor (fallback)">
          ...
          <div class="hv-notes">
            ...
            <p class="hv-notes__text">
              Safe entrance fade-up, 96px H1, full-bleed blueprint. Kept as the conservative default — useful as a
              baseline when a richer variant feels too risky on the day of ship.
            </p>
          </div>
        </div>
        ...
        <div class="hv-considered-variant">
          <h4 class="hv-vh">V2 — no entrance (system spotlight)</h4>
          <landing-ddl-stage width="full" label="V2 — system spotlight">
          ...
          <div class="hv-notes">
            ...
            <p class="hv-notes__text">
              The spotlight is now applied once at <code>landing-shell</code> (<code>scope="viewport"</code>) and
              follows the cursor across every page — including this section. V2 here just shows "no entrance" as the
              alternative pacing. Move your mouse anywhere on the site to feel it. Light theme: dark slate tint; dark
              theme: white tint.
            </p>
          </div>
        </div>
        ...
        <!-- β — Marquee in -->
        <div class="hv-considered-variant">
          <h4 class="hv-vh">β — marquee in</h4>
          <landing-ddl-stage width="full" label="β — marquee in">
          ...
          <div class="hv-notes">
            ...
            <p class="hv-notes__text">
              ...
              slides from left, em-dash hairline draws in, role italic enters from right (gentler 120px). Compositional,
              not "fade all". Reference: Pentagram launches, A24 sites.
            </p>
          </div>
        </div>
        ...
        <div class="hv-considered-variant">
          <h4 class="hv-vh">γ — diagonal mask wipe</h4>
          <landing-ddl-stage width="full" label="γ — diagonal mask wipe">
          ...
          <div class="hv-notes">
            ...
            <p class="hv-notes__text">
              H1 hidden under a 135° linear-gradient mask with a soft edge — letters fade in as the wipe sweeps
              diagonally across. After the name settles, the em-dash strokes in as a 1px hairline rule, then the role
              fades up. Editorial / print sequencing. Reference: It's Nice That, Common Sans.
            </p>
          </div>
        </div>
      </landing-ddl-considered>

      <!-- ═══ How to pick + library notes ══════════════════════════════════ -->
      <landing-ddl-section anchor="how-to-pick" heading="How to pick">
        <div class="hv-summary">
          <ul class="hv-summary__list">
            ...
            <li><strong>V1 / V2 / β / γ</strong> — exploration debris. Safe to delete next sweep.</li>
          </ul>
  ...
  styles: [
    `
      ...
      /* ─── Considered variant headings ────────────────────────────── */
      .hv-considered-variant + .hv-considered-variant {
        margin-top: 48px;
      }
      .hv-vh {
        margin: 0 0 16px 0;
...
export class DdlHero {
  readonly demo = DEMO;
  readonly variants = HERO_VARIANTS;
