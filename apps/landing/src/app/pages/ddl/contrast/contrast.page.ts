...
@Component({
  selector: 'landing-contrast-page',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [DecimalPipe, ContainerComponent, LandingBreadcrumbComponent, EyebrowComponent, LandingThemeToggleComponent],
  template: `
