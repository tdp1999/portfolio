 ...
 */
@Component({
  selector: 'landing-lightbox-page',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [ContainerComponent, EyebrowComponent, FigureComponent, LandingBreadcrumbComponent, LightboxDirective],
  templateUrl: './lightbox.page.html',
  styleUrl: './lightbox.page.scss',
})
