...
| `chips/_overview.md`         | Chip toggle family; three members by value shape; null-safe; two primitives (`mat-chip-listbox` for the groups, `mat-chip` for the boolean) because the semantic picks the role. | `patterns/chip-toggles`                                       |
