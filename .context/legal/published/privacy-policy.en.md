...
- **Name:** Phuong Tran
- **Location:** Vietnam
- **Contact:** [hello@thunderphong.com](mailto:hello@thunderphong.com)
...
|---|---|---|
| Railway Corp. | Application hosting | Singapore (ap-southeast-1) |
| Cloudflare, Inc. | CDN, DNS, bot protection, edge logs | Global edge; closest to Singapore |
| Resend (Resend.com, Inc.) | Outbound email delivery for contact form | United States |
| Umami (self-hosted on Railway) | Aggregate, cookieless traffic analytics | Singapore (ap-southeast-1) |
...
To exercise any of these rights, email me at [hello@thunderphong.com](mailto:hello@thunderphong.com). I will respond within **72 hours** for Vietnamese requests and within **one month** for EU/UK requests, in line with applicable law.
