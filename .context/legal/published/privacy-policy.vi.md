...
- **Quốc gia:** Việt Nam
- **Liên hệ:** [hello@thunderphong.com](mailto:hello@thunderphong.com)
...
| Bên xử lý | Mục đích | Nơi xử lý |
|---|---|---|
| Railway Corp. | Hosting ứng dụng | Singapore (ap-southeast-1) |
| Cloudflare, Inc. | CDN, DNS, chống bot, nhật ký edge | Edge toàn cầu; gần Singapore |
| Resend (Resend.com, Inc.) | Gửi email từ biểu mẫu liên hệ | Hoa Kỳ |
| Umami (self-host trên Railway) | Phân tích lưu lượng tổng hợp, không cookie | Singapore (ap-southeast-1) |
...
Để thực hiện các quyền trên, gửi email tới [hello@thunderphong.com](mailto:hello@thunderphong.com). Tôi sẽ phản hồi trong **72 giờ** đối với yêu cầu theo luật Việt Nam và trong **một tháng** đối với yêu cầu theo GDPR/UK GDPR.
...
- **Email:** [hello@thunderphong.com](mailto:hello@thunderphong.com)
