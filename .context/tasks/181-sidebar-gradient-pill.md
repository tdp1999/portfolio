...
## Acceptance Criteria
- [ ] Active menu item shows gradient background: `linear-gradient(135deg, rgba(99,102,241,0.15), rgba(139,92,246,0.08))`
- [ ] Active item has faint border: `box-shadow: 0 0 0 1px rgba(99,102,241,0.1)`
- [ ] Active item has subtle glow: `box-shadow: 0 0 20px -5px rgba(99,102,241,0.15)`
- [ ] Active item text is white (#fff), inactive items are muted (#94a3b8)
- [ ] Active item icon matches text color change
- [ ] Hover state on non-active items: slight bg lighten (`rgba(255,255,255,0.04)`)
- [ ] Smooth transition between states (`transition: all 0.2s ease`)
- [ ] Sidebar section labels (ADMIN, SYSTEM) properly styled: uppercase, small, #64748b
- [ ] User footer: avatar + name + ADMIN badge + email — consistent spacing
- [ ] No regressions for any app consuming ui-sidebar-*
