...
## Acceptance Criteria
- [ ] Page header: title h1 (left) + primary action button (right), same baseline
- [ ] Subtitle below title (#94a3b8, smaller text)
- [ ] Filter bar: row of filter controls (search input + dropdown selects), dark filled style (#1a1d27 bg, rounded-lg)
- [ ] FilterSearchComponent: magnifying glass icon, placeholder text, proper dark styling
- [ ] FilterSelectComponent: dropdown arrow, dark bg, proper dark styling
- [ ] Data table container: #1a1d27 bg, rounded-xl, border #2d3148
- [ ] Table header row: uppercase, small, #64748b text
- [ ] Table body rows: hover state (slightly lighter bg), proper text colors
- [ ] 3-dot action menu icon on each row's right side
- [ ] Fixed-bottom pagination bar: sticky above footer, #1a1d27 bg, border-top #2d3148
- [ ] Pagination content: "Items per page: 20" dropdown (left), "1-N of M" + arrows (right)
