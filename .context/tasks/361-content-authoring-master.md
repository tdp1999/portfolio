...
- EN [] · VI [] — Home Get-in-touch copy + 3 CTA labels (Hire/Freelance/Hi) · `[in-code]` `libs/landing/feature-home/src/lib/home.get-in-touch/home.get-in-touch.ts:20-40` · **Earmark:** reuse the "say hi" invitation (*"You scrolled this far? Might as well say hi."* / *"Dù gì cũng đã scroll tới đây rồi, chào mình một tiếng nhé."*) here — it belongs where the CTA action lives, not the footer.
